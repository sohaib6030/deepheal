    ...
    <LazyLoad height={200} effect={200}>
      <Card className={classes.root}>
        <CardActionArea
          ...
          onClick={() => goToWatchVideo(videos.id)}
        >
          {/* --card image -- */}
          <CardMedia className={classes.media} image={videos.thumbnail} />
          {/* --content -- */}
          <CardContent>
            <div className={classes.avatarText}>
              {
                <Avatar
                  src="https://www.citypng.com/public/uploads/preview/-11594728105y2bk1ek3dx.png"
