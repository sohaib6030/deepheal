...
function Sidebar({ open, handleDrawerClose }) {
  ...
  const { darkMode, changeDarkMode, userDetails, setUserSignOut } =
    useStateValue();
    ...
    >
      ...
      <ListItem className={classes.copyRightContainer}>
        <Typography gutterBottom component="p" color="textSecondary">
          © Copy Right 2021 Mustafa Dabah
        </Typography>
        <Box display="flex">
          <Link
            to={{
              pathname: "https://web.facebook.com/mostafa.dabah.9/?_rdc=1&_rdr",
            }}
            target="_blank"
          >
            <FacebookIcon />
          ...
          <Link
            to={{ pathname: "https://twitter.com/MustafaDabah" }}
            target="_blank"
          >
            <TwitterIcon />
          </Link>
          <Link
            to={{
              pathname: "https://www.linkedin.com/in/mustafa-dabah-ab58661a3/",
            }}
            target="_blank"
          >
            <LinkedInIcon />
          ...
          <Link
            to={{ pathname: "https://github.com/mustafaDabah" }}
            target="_blank"
          >
            <GitHubIcon />
          </Link>
